        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Bảng Lớp Học</h4>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <form action="/classroom/delete/{{ $classroom->id }}" method="post">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button onclick="return confirm('Bạn có chắc chắn muốn xóa mục này không?')" type="submit" class="btn btn-danger ti-trash btn-rounded">
                                                        Xóa</button>
                                                </form>
                                            </div>
